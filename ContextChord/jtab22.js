var jtab = {
  ...
  Chords : {
	...
	"Db/F"  : [ [ 0, [-1 ],  [-1 ],  [3,3],  [1,1],  [2,2],  [4,4] ], ],
    "Db/G#" : [ [ 3, [4,1],  [-1 ],  [6,2],  [6,3],  [6,4],  [-1 ] ], ],
    "Db/D#" : [ [ 2, [-1 ],  [6,2],  [-1 ],  [6,3],  [6,4],  [4,1] ], ],
    "Db/B"  : [ [ 0, [-1 ],  [2,2],  [-1 ],  [1,1],  [2,3],  [1,1] ], ],
	"Db/Ab" : [ [ 3, [4,1],  [-1 ],  [6,2],  [6,3],  [6,4],  [-1 ] ], ],
    "Db/Eb" : [ [ 2, [-1 ],  [6,2],  [-1 ],  [6,3],  [6,4],  [4,1] ], ],
	...
	"D#/A#" : [ [ 0, [-1 ],  [1,1],  [-1 ],  [3,2],  [4,4],  [3,3] ], ],
	"D#/Bb" : [ [ 0, [-1 ],  [1,1],  [-1 ],  [3,2],  [4,4],  [3,3] ], ],
    "D#/C#" : [ [ 0, [-1 ],  [4,2],  [-1 ],  [3,1],  [4,3],  [3,1] ], ],
    "D#/Db" : [ [ 0, [-1 ],  [4,2],  [-1 ],  [3,1],  [4,3],  [3,1] ], ],
    ...
    "Gb/A#" : [ [ 3, [6,2],  [-1 ],  [4,1],  [6,3],  [7,4],  [-1 ] ], ],
    "Gb/Bb" : [ [ 3, [6,2],  [-1 ],  [4,1],  [6,3],  [7,4],  [-1 ] ], ],
    "Gb/C#" : [ [ 0, [-1 ],  [4,3],  [-1 ],  [3,2],  [2,1],  [2,1] ], ],
    "Gb/Db" : [ [ 0, [-1 ],  [4,3],  [-1 ],  [3,2],  [2,1],  [2,1] ], ],
    "Gb/G#" : [ [ 0, [4,3],  [-1 ],  [4,4],  [3,2],  [2,1],  [-1 ] ], ],
    "Gb/Ab" : [ [ 0, [4,3],  [-1 ],  [4,4],  [3,2],  [2,1],  [-1 ] ], ],
    "Gb/E"  : [ [ 4, [-1 ],  [7,2],  [-1 ],  [6,1],  [7,3],  [6,1] ], ],
    ...
    "Ab/C"  : [ [ 0, [-1 ],  [3,2],  [-1 ],  [1,1],  [4,3],  [4,4] ], ],
    "Ab/D#" : [ [ 2, [-1 ],  [6,3],  [-1 ],  [5,2],  [4,1],  [4,1] ], ],
    "Ab/Eb" : [ [ 2, [-1 ],  [6,3],  [-1 ],  [5,2],  [4,1],  [4,1] ], ],
    "Ab/A#" : [ [ 2, [6,3],  [-1 ],  [6,4],  [5,2],  [4,1],  [-1 ] ], ],
    "Ab/Bb" : [ [ 2, [6,3],  [-1 ],  [6,4],  [5,2],  [4,1],  [-1 ] ], ],
    "Ab/F#" : [ [ 0, [2,2],  [-1 ],  [1,1],  [1,1],  [1,1],  [-1 ] ], ],
    "Ab/Gb" : [ [ 0, [2,2],  [-1 ],  [1,1],  [1,1],  [1,1],  [-1 ] ], ],
    ...
    "A#/F"  : [ [ 0, [1,1], [-1 ],  [3,2],  [3,3],  [3,4],  [-1 ] ], ],
    "A#/C"  : [ [ 0, [-1],  [3,2],  [-1 ],  [3,3],  [3,4],  [1,1] ], ],
    "A#/G#" : [ [ 1, [4,2], [-1 ],  [3,1],  [3,1],  [3,1],  [-1 ] ], ],
    "A#/Ab" : [ [ 1, [4,2], [-1 ],  [3,1],  [3,1],  [3,1],  [-1 ] ], ],
	...
	"B/Eb"  : [ [ 3, [-1],  [6,3],  [4,1],  [4,1],  [4,1],  [-1 ] ], ],
    "B/F#"  : [ [ 0, [2,1], [-1 ],  [4,2],  [4,3],  [4,4],  [-1 ] ], ],
    "B/Gb"  : [ [ 0, [2,1], [-1 ],  [4,2],  [4,3],  [4,4],  [-1 ] ], ],
